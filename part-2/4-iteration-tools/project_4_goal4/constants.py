...
# Files
fname_personal = 'materials/personal_info.csv'
fname_employment = 'materials/employment.csv'
fname_vehicles = 'materials/vehicles.csv'
fname_update_status = 'materials/update_status.csv'
...
update_status_parser = (
    str, parse_date, parse_date
)
